...
class Trainer(cntk_py.Trainer):
    ...
    def previous_test_minibatch_sample_count(self):
        '''
        The number of samples in the last minibatch tested with
        '''
    ...
    def summarize_evaluation_progress(self):
        '''
        Updates the progress writers with the summary of evaluation progress since start and resets the internal
        accumulators.
        '''
        return super(Trainer, self).summarize_evaluation_progress()